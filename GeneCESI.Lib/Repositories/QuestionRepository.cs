...
namespace GeneCESI.Lib.Repositories
{
    ...
    public class QuestionRepository : IQuestionRepository
    {
        ...
        public Question ReaderToObject(IDataReader reader)
        {
            ...
            question.FK_Answers = new AnswerRepository(new SqliteConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\murie\Documents\GeneCESI\GeneCESI_BDD.mdf;Integrated Security=True;Connect Timeout=30")).GetById((int)reader[1]);
            question.FK_Exam = new ExamRepository(new SqliteConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\murie\Documents\GeneCESI\GeneCESI_BDD.mdf;Integrated Security=True;Connect Timeout=30")).GetById((int)reader[2]);
